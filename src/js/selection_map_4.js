...
export default class selection_map_4 extends Phaser.Scene {
    constructor() {
      super({ key: "selection_map_4" }); // mettre le meme nom que le nom de la classe
    }
    /***********************************************************************/
    /** FONCTION PRELOAD 
  /***********************************************************************/
    ...
    preload() {
    //CHARGEMENT MUSIQUE
    this.load.audio("background6", "/src/assets/song/clash_of_clan.mp3");
  ...
  /***********************************************************************/
    ...
    create() {
      ...
      fct.doNothing();
      fct.doAlsoNothing();
      musique_de_fond6 = this.sound.add("background6");
      musique_de_fond6.play();
