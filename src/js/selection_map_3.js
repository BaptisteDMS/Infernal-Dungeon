...
export default class selection_map_3 extends Phaser.Scene {
    constructor() {
      super({ key: "selection_map_3" }); // mettre le meme nom que le nom de la classe
    }
    /***********************************************************************/
    /** FONCTION PRELOAD 
  /***********************************************************************/
    ...
    preload() {
    //CHARGEMENT MUSIQUE
    this.load.audio("background4", "/src/assets/song/clash_of_clan.mp3"); 
  ...
  /***********************************************************************/
    ...
    create() {
      ...
      fct.doNothing();
      fct.doAlsoNothing();
      musique_de_fond4 = this.sound.add("background4");
      musique_de_fond4.play();
